...
openstack volume create ${MY_SYS_VOLUME_NAME} --size ${MY_SYS_VOLUME_SIZE} --type SATA --availability-zone ${MY_AVAILABILITY_ZONE} --image ${MY_SYS_IMAGE_ID} --bootable
...
echo "Here is your server:"
openstack server show ${MY_SERVER_NAME}
echo "*** Done ***"
